...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((higher_education.shape[0] / df[df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])].shape[0]) * 100, 1)
    lower_education_rich = round((lower_education.shape[0] / df[~df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])].shape[0]) * 100, 1)
    ...
    # Общее количество людей, работающих минимальное количество часов в неделю
